...
class TextToVideoWan26SubmitInput(BaseModel):
    ...
    size: Optional[str] = Field(
        default=None,
        description="视频分辨率，默认值为 1920*1080（具体支持值请参考文档）",
    )
...
class TextToVideoWan26Submit(
    Component[TextToVideoWan26SubmitInput, TextToVideoWan26SubmitOutput],
):
    """
...
class TextToVideoWan26Fetch(
    Component[TextToVideoWan26FetchInput, TextToVideoWan26FetchOutput],
):
    """
