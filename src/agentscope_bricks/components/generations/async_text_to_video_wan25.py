...
class TextToVideoWan25Submit(
    Component[TextToVideoWan25SubmitInput, TextToVideoWan25SubmitOutput],
):
    """
...
class TextToVideoWan25Fetch(
    Component[TextToVideoWan25FetchInput, TextToVideoWan25FetchOutput],
):
    """
...
if __name__ == "__main__":
    ...
    text_to_video_submit = TextToVideoWan25Submit()
    text_to_video_fetch = TextToVideoWan25Fetch()
    ...
    async def main() -> None:
        ...
        try:
            ...
            # Step 3: Poll for task completion using TextToVideoFetch
