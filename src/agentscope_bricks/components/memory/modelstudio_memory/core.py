...
class AddMemory(
    Component[AddMemoryInput, AddMemoryOutput],
...
class SearchMemory(
    Component[SearchMemoryInput, SearchMemoryOutput],
    ModelStudioMemoryBase,
):
    """
...
class ListMemory(
    Component[ListMemoryInput, ListMemoryOutput],
    ModelStudioMemoryBase,
):
    """
...
class DeleteMemory(
    Component[DeleteMemoryInput, DeleteMemoryOutput],
    ModelStudioMemoryBase,
):
    """
...
class CreateProfileSchema(
    Component[CreateProfileSchemaInput, CreateProfileSchemaOutput],
    ModelStudioMemoryBase,
):
    """
...
class GetUserProfile(
    Component[GetUserProfileInput, GetUserProfileOutput],
    ModelStudioMemoryBase,
):
    """
