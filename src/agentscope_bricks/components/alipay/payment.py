...
from agentscope_bricks.components.alipay.base import (
    AP_RETURN_URL,
    AP_NOTIFY_URL,
    X_AGENT_CHANNEL,
...
class MobileAlipayPayment(Component[MobilePaymentInput, PaymentOutput]):
    """
    手机端支付宝支付组件
...
class WebPageAlipayPayment(Component[WebPagePaymentInput, PaymentOutput]):
    """
    电脑网页端支付宝支付组件
...
class AlipayPaymentQuery(Component[PaymentQueryInput, PaymentOutput]):
    """
    支付宝交易查询组件
...
class AlipayPaymentRefund(Component[PaymentRefundInput, PaymentOutput]):
    """
    支付宝交易退款组件
...
class AlipayRefundQuery(Component[RefundQueryInput, PaymentOutput]):
    """
    支付宝退款查询组件
